...
initial_abundance = [Yn_i, Yp_i, 0, 0, 0, 0, 0, 0]		# All initial abundances other than p and n are zero
...
print(f'\nComputing models for {n_runs} O_b0 values.\n')
...
np.save(f'fitting-O_b0-YHe3-{n_runs}-runs', YHe3)